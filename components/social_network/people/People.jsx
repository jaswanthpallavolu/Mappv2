		...
		<div className={secStyles.icon_section}>
			...
			>
				...
				<div className={styles.menu}>
					<SectionMenu
						states={{selectedSection, setSelectedSection}}
					/>
				</div>
				...
				{selectedSection ? (
					<>
						...
						/>
						<div
							className={`${customStyles.custom_scrollbar} ${styles.list}`}
						>
							<Friends
								dataprops={{requser, setRequser, search}}
							/>
						</div>
					</>
				) : (
