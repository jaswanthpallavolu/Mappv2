...
export default function FilterModal({ setQuery, setModal, query }) {
  ...
  const handleapply = () => {
    const query = {
      genre: genre,
      released: parseInt(year) || 2020,
      range: parseInt(rate) || 3,
      sort: ["year", 0],
      page: 1,
      nof: 20,
    };
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.category}>
          ...
          <div className={styles.options}>
            {filter_json["genres"].map((i) => (
              <button
                className={
                  genre.includes(i) ? styles.active : styles.optionsbutton
                }
                onClick={handleGenre}
                value={i}
                key={i}
        ...
        <div className={styles.btns}>
          <button className={styles.apply} onClick={handleclear}>
            Clear
          </button>
